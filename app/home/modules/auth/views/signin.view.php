      ...
      <div class="card" style="width: 48rem;">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="user_login" name="login" placeholder="Usuario o correo"
              required>
        ...
        <div class="card-footer text-center">
          <div class="d-flex justify-content-between">
            <a href="<?= APP_URL ?>/reset-password" class="btn btn-outline-secondary">
              <i class="fa fa-key"></i>
              Resetear Contraseña
            </a>
            <a href="<?= APP_URL ?>/signup" class="btn btn-outline-primary">
