                ...
                <td class="ps-3 py-3">
                  <div class="d-flex align-items-center gap-3">
                    <div class="position-relative">
                      <?php if (!empty($user->user_image) && file_exists(SITE_URL . "/uploads/user/" . $user->user_image)): ?>
                        <img src="<?= SITE_URL . "/uploads/user/" . $user->user_image ?>" alt="Avatar" class="rounded-circle"
                ...
                <td class="text-end pe-3">
                  <div class="btn-group">
                    ...
                    <button class="btn btn-sm btn-outline-danger"
                      sa-title="¿Eliminar a <?= htmlspecialchars($user->user_login) ?>?"
