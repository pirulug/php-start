  ...
  <div class="col-xl-8">
    <div class="card h-100">
      <div class="card-header pb-0 border-0 bg-transparent">
        <h5 class="card-title fw-bold"><i class="fa-solid fa-shield-halved me-1 text-primary"></i> Tipos de Captcha
          Soportados</h5>
        <p class="text-body-secondary small">Configura el motor de validación desde el panel de ajustes globales de
          seguridad.</p>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-sm table-borderless align-middle">
            ...
            <tbody>
              <tr>
                <td><span
                    class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill">Vanilla</span>
                </td>
              ...
              <tr>
                <td><span
                    class="badge bg-danger-subtle text-danger border border-danger-subtle rounded-pill">reCAPTCHA</span>
                </td>
              ...
              <tr>
                <td><span class="badge bg-info-subtle text-info border border-info-subtle rounded-pill">Turnstile</span>
                </td>
    ...
    <div class="card h-100 border-primary">
      ...
      <div class="card-body pt-0">
        <form action="<?= admin_route('componentes/captcha') ?>" method="POST">
          ...
          <div
            class="mb-4 bg-body-tertiary p-3 rounded-3 border text-center d-flex align-items-center justify-content-center"
      ...
      <div class="card-footer border-0 bg-transparent pt-0 pb-3">
        <div class="p-2 rounded-3 border bg-body-tertiary d-flex align-items-center justify-content-center text-center">
          <div class="small text-body-secondary">
            ...
            Motor activo: <span
              class="badge bg-body-secondary text-body border"><?= strtoupper($config->get('captcha_type') ?? 'VANILLA') ?></span>
          </div>
        </div>
      </div>
    </div>
