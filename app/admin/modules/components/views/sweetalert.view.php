    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <form id="demoForm" action="<?= admin_route('componentes/sweetalert') ?>" method="POST">
          <button type="button" class="btn btn-primary" sa-title="¿Enviar Formulario?"
            sa-text="Se procesarán los datos del formulario tras tu confirmación." sa-icon="question"
            sa-form-id="demoForm">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="d-flex flex-wrap gap-2">
          <!-- Alerta de Éxito -->
          <button type="button" class="btn btn-success" sa-title="¡Buen trabajo!"
            sa-text="La operación se realizó con éxito." sa-icon="success">
            <i class="fa fa-check me-1"></i> Éxito
          </button>

          <!-- Alerta de Error -->
          <button type="button" class="btn btn-danger" sa-title="Error detectado"
            sa-text="No se pudo completar la solicitud." sa-icon="error">
            <i class="fa fa-times me-1"></i> Error
          </button>

          <!-- Alerta de Advertencia -->
          <button type="button" class="btn btn-warning" sa-title="Atención"
            sa-text="Revisa los datos antes de continuar." sa-icon="warning">
            <i class="fa fa-exclamation-triangle me-1"></i> Advertencia
          </button>

          <!-- Alerta con Timer -->
          <button type="button" class="btn btn-info" sa-title="Auto-cierre"
            sa-text="Esta ventana se cerrará en 3 segundos." sa-icon="info" sa-timer="3000" sa-show-confirm-btn="false">
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        <p class="small">Al hacer clic en el siguiente botón se inyectará un elemento <code>data-sa-flash</code> al DOM
          para demostrar la detección automática del script <code>sa.js</code>.</p>
