...
<div class="row">
  <div class="col-12">
    <div class="card mb-3">
      ...
      <div class="card-body">
        <p>Motor especializado para la generación de códigos QR (2D) con soporte completo para niveles de corrección de errores (ECL), personalización de colores y estilos de módulos.</p>
      ...
      <div class="card-body">
        <div class="row text-center">
          <div class="col-6 mb-3">
            ...
            <img src="<?= APP_URL ?>/service/qrcode/render?s=qrl&d=ECL-LOW&sf=4" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6 mb-3">
            <label class="d-block small text-muted text-uppercase mb-2">Medio (M) - 15%</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?s=qrm&d=ECL-MEDIUM&sf=4" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Cuartil (Q) - 25%</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?s=qrq&d=ECL-QUARTILE&sf=4" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Alto (H) - 30%</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?s=qrh&d=ECL-HIGH&sf=4" class="qr-img-demo img-fluid border bg-body">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="row text-center">
          <div class="col-6 mb-3">
            ...
            <img src="<?= APP_URL ?>/service/qrcode/render?d=BLUE-QR&sf=4&bc=E3F2FD&fc=0D47A1" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6 mb-3">
            <label class="d-block small text-muted text-uppercase mb-2">Negativo (Dark)</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=DARK-QR&sf=4&bc=212529&fc=F8F9FA" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Estilo Moderno</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=MODERN&sf=4&bc=FFF5F5&fc=E53E3E" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Alto Contraste</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=CONTRAST&sf=4&bc=000&fc=FFF" class="qr-img-demo img-fluid border bg-body">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="row text-center">
          <div class="col-6 mb-3">
            ...
            <img src="<?= APP_URL ?>/service/qrcode/render?d=DOTS-80&sf=4&md=0.8" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6 mb-3">
            <label class="d-block small text-muted text-uppercase mb-2">Densidad 60% (md=0.6)</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=DOTS-60&sf=4&md=0.6" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Puntos Finos (md=0.4)</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=FINE-DOTS&sf=4&md=0.4" class="qr-img-demo img-fluid border bg-body">
          </div>
          <div class="col-6">
            <label class="d-block small text-muted text-uppercase mb-2">Máxima Densidad (Default)</label>
            <img src="<?= APP_URL ?>/service/qrcode/render?d=SOLID-QR&sf=4&md=1" class="qr-img-demo img-fluid border bg-body">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body text-center">
        <div class="mb-4">
          ...
          <img src="<?= APP_URL ?>/service/qrcode/render?d=PADDING-QR&sf=3&p=40&bc=F8F9FA" class="qr-img-demo img-fluid border bg-body">
        ...
        <div class="mb-0">
          ...
          <img src="<?= APP_URL ?>/service/qrcode/render?d=BIG-QR&sf=10" class="qr-img-demo img-fluid border bg-body" style="max-width: 120px;">
  ...
  <div class="card-body">
    <form id="qrForm">
      <div class="row g-3">
        <div class="col-md-6">
          ...
          <textarea class="form-control" id="qrText" rows="2" placeholder="Ingresa el texto o URL...">https://github.com/pirulug/php-start</textarea>
        </div>
        <div class="col-md-3">
    ...
    <div class="mt-4 text-center">
      <div id="resultContainer" class="p-4 bg-body rounded border d-none qr-example-card">
        <img id="qrResultImg" src="" class="img-fluid border p-2 bg-white rounded shadow-sm mb-3" style="max-width: 250px;">
        <div class="mt-2">
