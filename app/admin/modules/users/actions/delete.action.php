...
// Eliminación Segura (Usermeta primero, luego Usuario)
try {
  $connect->beginTransaction();

  // 1. Borrar metadatos
  $stmt_meta = $connect->prepare('DELETE FROM usermeta WHERE user_id = :id');
  $stmt_meta->bindParam(':id', $id, PDO::PARAM_INT);
  $stmt_meta->execute();
