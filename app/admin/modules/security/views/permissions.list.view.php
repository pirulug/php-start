                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-3">
                    ...
                    <div class="d-flex gap-2">
                      <a href="<?= admin_route("permission/edit/" . $perm->permission_id) ?>"
                        class="btn btn-sm btn-outline-primary text-uppercase small fw-bold" data-bs-toggle="tooltip" title="Editar">
                        <i class="fa fa-pen fa-fw"></i>
                      </a>

                      <button type="button" class="btn btn-sm btn-outline-danger text-uppercase small fw-bold" sa-title="¿Eliminar permiso?"
