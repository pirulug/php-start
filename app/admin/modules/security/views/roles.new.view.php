      ...
      <div class="card" style="position: sticky; top: 1rem;">
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" id="role_name" name="role_name" class="form-control" placeholder="Ej: Editor de Blog" required autofocus>
            <div class="form-text">El nombre visible para los usuarios.</div>
          </div>

          <div class="mb-3">
            <label for="role_description" class="form-label">Descripción</label>
            <textarea id="role_description" class="form-control" name="role_description" rows="5"
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <div class="form-check p-3 rounded h-100 bg-body border d-flex align-items-start gap-2" 
                            ...
                            <input id="perm-<?= $perm->permission_id ?>" class="form-check-input mt-1" type="checkbox"
                              name="permissions[]" value="<?= $perm->permission_id ?>" data-perm-key="<?= htmlspecialchars($perm->permission_key_name) ?>">
