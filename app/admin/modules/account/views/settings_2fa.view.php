    ...
    <?php if ($is_2fa_enabled): ?>
      ...
      <form action="" method="POST">
        ...
        <div class="bg-body p-3 rounded d-flex justify-content-end gap-2 sticky-bottom mt-3">
          <a href="<?= admin_route("account/profile") ?>" class="btn btn-outline-secondary px-4 text-uppercase small fw-bold">
          ...
          <div class="card-body">
            <div class="alert alert-warning border-0 bg-warning-subtle mb-4 d-flex align-items-center gap-3 p-3" role="alert">
              ...
              <div>
                ...
                <div class="small text-body-secondary">
                  <?= __("Te recomendamos activar la autenticación de doble factor para evitar accesos no autorizados a tu cuenta de administración.") ?>
                </div>
              </div>
            </div>
            ...
            <div class="row g-3">
              ...
              <div class="col-lg-6">
                ...
                <div class="d-flex gap-2 mb-4 justify-content-center">
                  <input class="form-control text-center fw-bold fs-4 p-2 verification-code-input" type="text" maxlength="1" pattern="[0-9]" inputmode="numeric" style="width: 44px; height: 44px" required />
                  <input class="form-control text-center fw-bold fs-4 p-2 verification-code-input" type="text" maxlength="1" pattern="[0-9]" inputmode="numeric" style="width: 44px; height: 44px" required />
                  <input class="form-control text-center fw-bold fs-4 p-2 verification-code-input" type="text" maxlength="1" pattern="[0-9]" inputmode="numeric" style="width: 44px; height: 44px" required />
                  <input class="form-control text-center fw-bold fs-4 p-2 verification-code-input" type="text" maxlength="1" pattern="[0-9]" inputmode="numeric" style="width: 44px; height: 44px" required />
                  <input class="form-control text-center fw-bold fs-4 p-2 verification-code-input" type="text" maxlength="1" pattern="[0-9]" inputmode="numeric" style="width: 44px; height: 44px" required />
