 ...
 * UploadImage
 *
 * Clase encargada de la carga, validación y procesamiento avanzado de imágenes.
 * Soporta conversión de formatos, optimización de calidad, redimensionamiento
 * (proporcional o recorte) y descarga desde URLs remotas.
 *
 * @author Pirulug
...
class UploadImage {
  ...
  /**
   * Asigna una URL remota para descargar la imagen.
   */
  ...
  /**
   * Define las extensiones soportadas.
   */
  ...
  /**
   * Define el formato al que se debe convertir la imagen (ej: webp).
   */
  ...
  /**
   * Define el nivel de optimización/calidad (0-10).
   */
  ...
  /**
   * Define un nombre de archivo personalizado.
   */
  ...
  /**
   * Define un prefijo para el nombre final.
   */
  ...
  /**
   * Registra una variante de redimensionamiento (ej: thumbnail, cover).
   */
  ...
  /**
   * Define el ancho principal para la imagen original.
   */
  ...
  /**
   * Define el alto principal para la imagen original.
   */
  ...
  /**
   * Ejecuta el flujo completo de carga, descarga, redimensionamiento y guardado.
   *
  ...
  // --------------------------------------------------------------------------
  // SECCIÓN: LÓGICA INTERNA (DESCARGA Y PROCESAMIENTO)
  // --------------------------------------------------------------------------

  /**
   * Descarga una imagen remota validando su tipo y tamaño.
   */
  ...
  /**
   * Procesa la imagen utilizando Imagick (si está disponible) o GD.
   */
  ...
  /**
   * Fallback de procesamiento mediante la librería GD.
   */
  ...
  /**
   * Redimensiona una imagen utilizando Imagick. Soporta proporcionalidad o recorte.
   */
