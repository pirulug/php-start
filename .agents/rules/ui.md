...
- Iconos: FontAwesome obligatorio
...
Para campos de contraseña, usa estrictamente la siguiente estructura. El atributo data-pr-toggle-password ya tiene la lógica integrada en el tema global, por lo que NO debes añadir scripts manuales para el toggle. **No se deben usar iconos prepend (`input-group-text`) en ningún input, incluyendo el de contraseña.**
