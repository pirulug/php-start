                  ...
                  <?php if ($accessControl->hasAccess($subItem['roles'], $role)): // Verificar acceso a los sub ítems ?>
                    <li class="sidebar-item <?= $theme_path == $subItem['path'] ? "active" : "" ?>">
                      <a class="sidebar-link"
                        href="<?= SITE_URL_ADMIN . "/" . $subItem['link'] ?>"><?= $subItem['title'] ?></a>
                    </li>
                  <?php endif; ?>
                <?php endforeach; ?>
              </ul>
      ...
      <ul class="navbar-nav navbar-align">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item" href="<?= SITE_URL_ADMIN ?>/account/profile.php">
              <i class="align-middle me-1" data-feather="user"></i>
              Perfil
            </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="<?= SITE_URL_ADMIN ?>/account/settings.php">
              <i class="align-middle me-1" data-feather="settings"></i>
              Contraseña
            </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="<?= SITE_URL_ADMIN ?>/logout.php">
