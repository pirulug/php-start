...
('site_social', '[{\"name\":\"Facebook\",\"url\":\"https:\\/\\/facebook.com\",\"icon\":\"\"}]'),
('tracking_type', 'internal'),
('version', '1.0'),
('modules', '{"admin":{"auth":{"active":true,"order":1},"account":{"active":true,"order":2},"dashboard":{"active":true,"order":3},"components":{"active":true,"order":4},"security":{"active":true,"order":5},"users":{"active":true,"order":6},"policies":{"active":true,"order":7},"settings":{"active":true,"order":8},"logs":{"active":true,"order":9},"modules":{"active":true,"order":10}},"front":{"index":{"active":true,"order":1},"account":{"active":true,"order":2},"auth":{"active":true,"order":3},"errors":{"active":true,"order":4},"test":{"active":true,"order":5},"docs":{"active":true,"order":6},"policies":{"active":true,"order":7}},"api":{"users":{"active":true,"order":1},"test":{"active":true,"order":2}}}'),,
