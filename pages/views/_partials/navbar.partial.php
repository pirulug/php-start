<nav class="navbar navbar-expand-lg bg-body">
  <div class="container">
    <a class="navbar-brand" href="<?= $site_url->link() ?>">
      <img class="brand-logo-ligth" src="<?= $static_url->logo($st_whitelogo) ?>" alt="Logo Light" class="logo-light"
        height="40">
      <img class="brand-logo-dark" src="<?= $static_url->logo($st_darklogo) ?>" alt="Logo Dark" class="logo-dark d-none"
        height="40">
    </a>
    ...
    <div class="offcanvas offcanvas-start" id="navbarResponsive">
      <div class="offcanvas-header">
        <a class="navbar-brand" href="<?= $site_url->link() ?>">
          <img class="brand-logo-ligth" src="<?= $static_url->logo($st_whitelogo) ?>" alt="Logo Light"
            class="logo-light" height="40">
          <img class="brand-logo-dark" src="<?= $static_url->logo($st_darklogo) ?>" alt="Logo Dark"
